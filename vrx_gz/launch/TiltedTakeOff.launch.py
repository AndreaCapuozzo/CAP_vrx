...
def launch(context, *args, **kwargs):
    ...
    gz_paused = LaunchConfiguration('paused').perform(context).lower() == 'false'
    ...
    if (sim_mode == 'bridge' or sim_mode == 'full') and bridge_competition_topics:
        launch_processes.extend(vrx_gz.launch.competition_bridges(world_name, competition_mode))
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'robot_model_path', 
            default_value='/droneDev/PX4-Autopilot/Tools/simulation/gz/models/x500/model.sdf', 
            description='Path to robot SDF model file'),
        DeclareLaunchArgument(
            'initial_x', 
            default_value='-580.0', 
        ...
        DeclareLaunchArgument(
            ...
            'initial_R', 
            default_value='0.0', 
            description='Initial R orientation of the robot'),
        DeclareLaunchArgument(
            'initial_P', 
            default_value='0.0', 
            description='Initial P orientation of the robot'),
        DeclareLaunchArgument(
            'initial_Y', 
            default_value='0.0', 
        ...
        DeclareLaunchArgument(
            'competition_mode',
            default_va# Copyright 2021 Open Source Robotics Foundation, Inc.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
='Additional arguments to be passed to gz sim. '),
        OpaqueFunction(function=launch),
    ])
'''
