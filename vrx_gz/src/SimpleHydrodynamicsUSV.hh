 ...
 *
 */
#ifndef VRX_SIMPLE_HYDRODYNAMICS_USV_HH_
#define VRX_SIMPLE_HYDRODYNAMICS_USV_HH_
...
{
  // Forward declaration
  class SimpleHydrodynamicsUSVPrivate;
  ...
  /// # Example
  /// <plugin
  ///   filename="libSimpleHydrodynamicsUSV.so"
  ///   name="gz::sim::systems::SimpleHydrodynamicsUSV">
  ...
  class SimpleHydrodynamicsUSV
      : public gz::sim::System,
        public gz::sim::ISystemConfigure,
        public gz::sim::ISystemPreUpdate
  {
    /// \brief Constructor.
    public: SimpleHydrodynamicsUSV();

    /// \brief Destructor.
    public: ~SimpleHydrodynamicsUSV() override = default;
    ...
    private: std::unique_ptr<SimpleHydrodynamicsUSVPrivate> dataPtr;
  };
}
