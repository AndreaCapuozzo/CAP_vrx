...
#include "SimpleHydrodynamicsUSV.hh"

using namespace gz;
using namespace sim;
using namespace vrx;

class vrx::SimpleHydrodynamicsUSVPrivate
{
...
//////////////////////////////////////////////////
SimpleHydrodynamicsUSV::SimpleHydrodynamicsUSV()
  : dataPtr(std::make_unique<SimpleHydrodynamicsUSVPrivate>())
{
}

//////////////////////////////////////////////////
void SimpleHydrodynamicsUSV::Configure(const Entity &_entity,
    ...
    EventManager &/*_eventMgr*/)
{
  ...
  gzdbg << "SimpleHydrodynamicsUSV plugin successfully configured with the "
...
//////////////////////////////////////////////////
void SimpleHydrodynamicsUSV::PreUpdate(
    const sim::UpdateInfo &_info,
    sim::EntityComponentManager &_ecm)
{
  GZ_PROFILE("SimpleHydrodynamicsUSV::PreUpdate");
  ...
  // TO CHECK IF THE VEHICLE IS ON WATER
  ...
  bool on_water;
  float epsilon = 0;
  if((kDdz) < (0 + epsilon)) //0.24 sta lì per compensare il fatto che il baselink del drone è rialzato
  {
    on_water = true;
  }
  else
  ...
  if(on_water)
  {
    ...
    gzdbg<<"Hydrodynamics active"<<std::endl;
  }
}

GZ_ADD_PLUGIN(vrx::SimpleHydrodynamicsUSV,
              sim::System,
              SimpleHydrodynamicsUSV::ISystemConfigure,
              SimpleHydrodynamicsUSV::ISystemPreUpdate)

GZ_ADD_PLUGIN_ALIAS(vrx::SimpleHydrodynamicsUSV,
                    "vrx::SimpleHydrodynamicsUSV")
