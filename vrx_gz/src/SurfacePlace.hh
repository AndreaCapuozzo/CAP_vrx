...
#ifndef VRX_SURFACE_PLACE_HH_
#define VRX_SURFACE_PLACE_HH_
...
namespace vrx
{
        ...
        public gz::sim::ISystemPreUpdate
  {
    ...
    /// \brief Destructor.
    public: ~SurfacePlace() override = default;
    ...
    /// \brief Convenience function for calculating the area of cylindrical part submerged.
